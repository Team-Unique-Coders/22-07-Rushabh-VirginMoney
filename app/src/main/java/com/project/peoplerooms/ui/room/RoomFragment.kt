...
import com.project.peoplerooms.databinding.FragmentRoomBinding
...
//                throw NullPointerException("You crashed!")
        ...
        viewModel.text.observe(viewLifecycleOwner){
                response ->
            when(response){
                is com.project.peoplerooms.ui.room.ApiResponse.Loading -> {
                    binding.apply {
                ...
                is com.project.peoplerooms.ui.room.ApiResponse.Error ->{
                    binding.apply {
                ...
                is com.project.peoplerooms.ui.room.ApiResponse.Success ->{
                    binding.apply {
                        tvError.visibility = View.GONE
                        pbLoading.visibility = View.GONE
